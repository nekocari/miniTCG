...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active" aria-current="page">HTML Template bearbeiten</li>
  </ol>
</nav>
...
<p class="text-center mx-2">
	<a class="btn btn-dark" href="<?php echo Routes::getUri('admin_deck_type_edit').'?id='.$deck_type->getId();?>">zurück zur Deck Art</a> &bull;
	<input class="btn btn-primary" type="submit" name="saveTemplate" value="speichern">
