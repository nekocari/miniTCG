						...
						<ul class="nav">
							<li class="nav-item d-none d-sm-block">
								<a class="nav-link" href="<?php echo Routes::getUri('member_cardmanager');?>">
									<span class="icon"><i class="fas fa-folder-open" title="Karten Manager"></i></span>
									<span class="d-none d-xl-inline">Karten</span>
								</a>
							</li>
							<li class="nav-item d-none d-sm-block">
								<a class="nav-link" href="<?php echo Routes::getUri('messages_recieved');?>">
									<span class="icon">
										<i class="fas fa-envelope-open" title="Nachrichten"></i>
									...
									<span class="d-none d-xl-inline">Nachrichten</span>
								</a>
							</li>
							<li class="nav-item d-none d-sm-block">
								<a class="nav-link" href="<?php echo Routes::getUri('trades_recieved');?>">
									<span class="icon">
										<i class="fas fa-sync-alt" title="Taunschanfragen"></i>
									...
									<span class="d-none d-xl-inline">Tauschen</span>
								</a>
							</li>
