...
<ul class="nav nav-tabs">
	<li class="nav-tab"><a class="nav-link active" href="<?php echo RoutesDb::getUri('messages_recieved')?>">Eingang</a></li>
	<li class="nav-tab"><a class="nav-link" href="<?php echo RoutesDb::getUri('messages_sent')?>">Ausgang</a></li>
</ul>
...
<div class="my-4"><?php if(count($msgs) == 0){ $this->renderMessage('info','Keine  Nachrichten'); } ?></div>