		...
		<?php if(count($subcategory->getDecks()) > 0){ ?>
        	...
        	<tr>
        		...
        		<td>
        			...
        			<small>by <?php echo $deck->getCreatorName(); ?></small>
        		</td>
        	</tr>
        	<?php } ?>
    	<?php }else{ echo "<tr><td colspan='3'>"; $this->renderMessage('info','no decks'); echo "</tr></td>"; }
        } ?>
	</table>
</div>
<?php }else{ $this->renderMessage('info','There are no subcategories yet.'); } ?>