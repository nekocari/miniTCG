...
<p class="text-center">
	<a class="btn btn-outline-dark <?php if($curr_order == 'deckname'){ echo 'active'; } ?>" 
		href="<?php echo Routes::getUri('member_mastercards'); ?>?order_by=deckname">sort by name</a>
	<a class="btn btn-outline-dark <?php if($curr_order == 'date'){ echo 'active'; } ?>" 
		href="<?php echo Routes::getUri('member_mastercards'); ?>?order_by=date">sort by date</a>
</p>
...
<?php if(count($mastered_decks) == 0){ $this->renderMessage('info','No masterd decks.'); } ?>
