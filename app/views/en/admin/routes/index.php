...
<p class="text-center"><a class="btn btn-primary" href="<?php echo Routes::getUri('admin_routes_add');?>">create new route</a></p>
    	...
    	<tr style="white-space:nowrap">
    		...
    		<td>
    			<form class="justify-content-end form-inline" method="POST" action="">
    				...
    				<?php }else{ ?>
    					<button class="btn btn-secondary btn-sm del-link mx-1" disabled><i class="fas fa-times"></i> <span class="d-none d-md-inline">not deletable</span></button>
    				<?php } ?>
