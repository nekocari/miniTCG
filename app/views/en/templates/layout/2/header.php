<html lang="en">
	...
	<head>
    	...
    	<!-- default bootstrap 5 -->
		<link href="public/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-KK94CHFLLe+nY2dmCWGMq91rCGa5gtU4mk92HdvYe+M/SXH301p5ILy+dN9+nJOZ" crossorigin="anonymous">		
					...
					<div class="collapse navbar-collapse" id="navbar1">
						<ul class="navbar-nav ms-auto">
							...
							<li class="nav-item dropdown">
								<a class="nav-link dropdown-toggle" href="#"  id="decksDropdown" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fas fa-folder text-primary"></i> Decks</a>
			...
			<nav class="navbar navbar-expand-sm container">  
				<div class="container-fluid">
					...
					<button class="btn btn-sm btn-outline-dark dropdown-toggle" data-bs-toggle="collapse" data-bs-target="#members-online" aria-expanded="false" aria-controls="members-online">
						<?php echo count(MemberOnline::getVisible($this->login->getUser())); ?> <span class="d-none d-md-inline">members</span> online
					</button>
							...
							<ul class="mt-1 navbar-nav justify-content-end" id="member-links">
								<li class="nav-item">
									<a class="nav-link d-flex justify-content-between align-items-center" href="<?php echo Routes::getUri('member_cardmanager');?>">
										<span class="position-relative"><i class="fas fa-folder-open me-lg-1" title="Card Manager"></i><span class="d-none d-lg-inline">Card Manager</span></span>
									</a>
								</li>
								<li class="nav-item">
									<a class="nav-link d-flex justify-content-between align-items-center" href="<?php echo Routes::getUri('messages_recieved');?>">
										<span class="position-relative"><i class="fas fa-envelope-open me-lg-1" title="Messages"></i><span class="d-none d-lg-inline">Messages</span>
								...
								<li class="nav-item">
									<a class="nav-link d-flex justify-content-between align-items-center" href="<?php echo Routes::getUri('trades_recieved');?>">
										<span class="position-relative"><i class="fas fa-sync-alt me-lg-1" title="Trade Offers"></i><span class="d-none d-lg-inline">Trade Offers</span>
						...
						<div class="collapse navbar-collapse justify-content-end" id="navbar2">
							<ul class="navbar-nav">
								...
								<li class="nav-item ms-2">
									<a class="btn btn-dark" href="<?php echo Routes::getUri('signup');?>">Register</a>
								</li>
							</ul>
						</div>
					<?php } ?>
