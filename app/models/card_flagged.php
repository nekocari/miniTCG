...
class CardFlagged extends Card {
    ...
    public static function getCardsByStatus($user_id, $status, $grouped = true, $compare_user_id, $query_style = 'join') {
        ...
        if(!is_null($compare_user_id) AND $compare_user_id != $user_id AND $status == 'trade'){ // TODO -> custom stati fix
